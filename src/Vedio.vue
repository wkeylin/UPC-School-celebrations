<template>
    <section class="content">
		...
		<div class="essay">
			...
			<div class="article">
				<iframe :src="artical[0].url" scrolling="no" width="100%" frameborder="0" style="min-height:500px;"></iframe>
            </div>
            <!-- <iframe id="iFrame1" name="iFrame1" width="100%" onload="this.height=iFrame1.document.body.height" frameborder="0" :src="artical[0].url"></iframe> -->
...
export default {
  ...
  computed: {
    contentHtml() {
      return this.artical[0].content.split(
